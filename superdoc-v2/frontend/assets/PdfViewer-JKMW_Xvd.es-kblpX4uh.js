import{a as N,u as O,s as $,r as L,o as E,b as W,c as _,d as D,e as A,f as F,h as I,i as H,j as U,k as h,N as q,T as G,p as K,w as R,l as J,m as X,n as M,q as Y,t as T,v as V,x as Z,y as Q,z as ee,A as te,B as se,C as y,D as ne,E as j}from"./superdoc-CYouBAjQ.js";function oe(n){const{opacityDisabled:e,heightTiny:s,heightSmall:t,heightMedium:o,heightLarge:r,heightHuge:p,primaryColor:d,fontSize:i}=n;return{fontSize:i,textColor:d,sizeTiny:s,sizeSmall:t,sizeMedium:o,sizeLarge:r,sizeHuge:p,color:d,opacitySpinning:e}}const ie={common:Y,self:oe},re=T([T("@keyframes spin-rotate",`
 from {
 transform: rotate(0);
 }
 to {
